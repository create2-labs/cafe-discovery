...
| **IMM-6b-6** | `discovery/plan-usage-backfill` | `cafe-discovery` | — | **IMM-6b-2** | ~~Backfill ledger~~ **annulé** (pas de prod ; reset DB ; ledger rempli par IMM-6b-4 à partir du go-live). |
