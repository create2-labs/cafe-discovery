...
### 6.1 Liste wallet (la liste wallet historique)
...
### 6.2 Liste TLS (la liste TLS historique)
...
- **Auth** : tous les appels API nécessitent une authentification. Les endpoints « list anonymous » (la liste wallet historique/anonymous, la liste TLS historique/anonymous) ont été supprimés.
