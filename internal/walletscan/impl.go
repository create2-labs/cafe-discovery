...
func (e *WalletScanEngine) scanAllNetworks(ctx context.Context, address string) ([]domain.NetworkResult, []string, string, string, string) {
	var networks []string
	...
	for networkName, client := range e.clients {
		result, err := e.scanNetwork(ctx, client, networkName, address)
		if err != nil {
			continue
		}
...
func (e *WalletScanEngine) extractKeyExposureInfo(networkResults []domain.NetworkResult) (bool, bool) {
	keyExposed := false
	isERC4337 := false
...
func (e *WalletScanEngine) buildScanResult(address string, data scanResultData, networks []string) *domain.ScanResult {
...
func (e *WalletScanEngine) scanNetwork(ctx context.Context, client *evm.Client, networkName string, address string) (*domain.NetworkResult, error) {
	publicKey, txHash := e.tryRecoverPublicKeyFromMoralis(ctx, client, address, networkName)
	...
	isERC4337 := e.checkERC4337Support(ctx, client, address, isEOA)
...
func (e *WalletScanEngine) tryRecoverPublicKeyFromMoralis(ctx context.Context, client *evm.Client, address, networkName string) (string, string) {
	if e.moralisClient == nil || client.MoralisChainName == "" {
		return "", ""
	}

	moralisTxs, err := e.moralisClient.GetTransactionsByAddress(address, client.MoralisChainName)
	...
	recoveredKey, _, err := e.RecoverPublicKeyFromTransactionData(ctx, client, txData, txHash)
...
func (e *WalletScanEngine) checkERC4337Support(ctx context.Context, client *evm.Client, address string, isEOA bool) bool {
	if isEOA {
		return false
	}
...
func (e *WalletScanEngine) determineAccountType(results []domain.NetworkResult) (domain.AccountType, domain.Algorithm, domain.NISTLevel) {
...
func (e *WalletScanEngine) calculateRiskScore(results []domain.NetworkResult, accountType domain.AccountType, nistLevel domain.NISTLevel) float64 {
...
/*
func (e *WalletScanEngine) determineRiskCategory(riskScore float64, nistLevel domain.NISTLevel) domain.RiskCategory {
...
func (e *WalletScanEngine) RecoverPublicKeyFromTransactionData(ctx context.Context, client *evm.Client, txData json.RawMessage, txHash string) (string, string, error) {
	txJSON, err := e.parseTransactionJSON(txData)
	if err != nil {
		return "", "", err
	}

	fields := e.extractTransactionFields(txJSON)
	isEIP1559 := e.isEIP1559Transaction(txJSON, fields)
	chainID := e.parseChainID(fields.chainIDHex)
	if chainID == nil {
	...
	v, err := e.calculateV(txJSON, isEIP1559, chainID)
	if err != nil {
		return "", "", err
	}

	data, err := e.decodeInputData(fields.inputData)
	if err != nil {
		return "", "", err
	}

	to := e.parseToAddress(fields.toAddr)
	tx, err := e.buildTransaction(fields, isEIP1559, chainID, to, data, v)
	if err != nil {
		return "", "", err
	}

	yParity := e.extractYParity(txJSON, isEIP1559)
...
func (e *WalletScanEngine) parseTransactionJSON(txData json.RawMessage) (map[string]interface{}, error) {
...
func (e *WalletScanEngine) extractTransactionFields(txJSON map[string]interface{}) txFields {
...
func (e *WalletScanEngine) isEIP1559Transaction(txJSON map[string]interface{}, fields txFields) bool {
...
func (e *WalletScanEngine) parseChainID(chainIDHex string) *big.Int {
...
func (e *WalletScanEngine) calculateV(txJSON map[string]interface{}, isEIP1559 bool, chainID *big.Int) (*big.Int, error) {
	if isEIP1559 {
		return e.calculateVForEIP1559(txJSON, chainID)
	}
	return e.calculateVForLegacy(txJSON), nil
}

// calculateVForEIP1559 calculates v for EIP-1559 transactions
func (e *WalletScanEngine) calculateVForEIP1559(txJSON map[string]interface{}, chainID *big.Int) (*big.Int, error) {
...
func (e *WalletScanEngine) calculateVForLegacy(txJSON map[string]interface{}) *big.Int {
	vHex, _ := txJSON["v"].(string)
	return hexToBigInt(vHex)
}

// decodeInputData decodes the input data from hex string
func (e *WalletScanEngine) decodeInputData(inputData string) ([]byte, error) {
...
func (e *WalletScanEngine) parseToAddress(toAddr string) *common.Address {
...
func (e *WalletScanEngine) buildTransaction(fields txFields, isEIP1559 bool, chainID *big.Int, to *common.Address, data []byte, v *big.Int) (*types.Transaction, error) {
	...
	if isEIP1559 {
		return e.buildEIP1559Transaction(params), nil
	}
	return e.buildLegacyTransaction(params), nil
}

// buildEIP1559Transaction builds an EIP-1559 transaction
func (e *WalletScanEngine) buildEIP1559Transaction(params txBuildParams) *types.Transaction {
...
func (e *WalletScanEngine) buildLegacyTransaction(params txBuildParams) *types.Transaction {
...
func (e *WalletScanEngine) extractYParity(txJSON map[string]interface{}, isEIP1559 bool) *big.Int {
	if !isEIP1559 {
		return nil
	}
	yParityHex, hasYParity := txJSON["yParity"].(string)
